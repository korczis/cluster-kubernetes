...
kubectl create --save-config -f ${ROOT_DIR}/stateful-sets/couchbase-admin-server.yaml
kubectl create --save-config -f ${ROOT_DIR}/stateful-sets/couchbase-server.yaml
